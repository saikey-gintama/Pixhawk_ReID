...
사용법:
  # 기본 (noaa19, 2019~2025-06)
  python poes_noaa19_download.py

  # 기간/위성 지정
  python poes_noaa19_download.py --sat noaa19 --start 20190101 --end 20250630

  # 저장 경로 지정
  python poes_noaa19_download.py --out D:/VS_code/Pixhawk_ReID/Experiment_window/C_NOAA19/raw_nc

옵션:
  --sat       위성 코드 (기본: noaa19). 폴더명/파일명에 모두 사용.
              metop03 -> 파일명 prefix 'm03', noaa19 -> 'n19' 등 SAT_CODE_MAP 참고
  --start     시작일 YYYYMMDD (기본: 20190101)
  --end       종료일 YYYYMMDD (기본: 20250630; NOAA19는 2025-06까지만 관측)
...
def main():
    ...
    parser.add_argument("--sat", default="noaa19",
                        choices=list(SAT_CODE_MAP),
                        help="위성 (기본: noaa19)")
    parser.add_argument("--start", default="20190101", help="시작일 YYYYMMDD")
    parser.add_argument("--end", default="20250630", help="종료일 YYYYMMDD")
