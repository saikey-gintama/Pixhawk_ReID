...
## 플랫폼/환경
- torch_threads: 1
- core_pin: {'pinned': True, 'core': 0, 'reason': None}
- clocks(nvpmodel/jetson_clocks): {'nvpmodel_mode': 'NV Power Mode: 15W\n0', 'jetson_clocks_status': 'SOC family:tegra234  Machine:NVIDIA Jetson Orin Nano Developer Kit\nError: Run this script(/usr/bin/jetson_clocks) as a root user', 'nvpmodel_available': True, 'jetson_clocks_available': True}
- device: cpu
- os: posix
...
## 버스트 모드
- tcn_infer: n_iter=28509, duration_s=60.2, tegra표본 idle=61/burst=61, energy/op=1.6837mJ, cpu-초/op(독립추정)=0.002091s
- fsm_eval: n_iter=1458536, duration_s=62.2, tegra표본 idle=61/burst=63, energy/op=0.0362mJ, cpu-초/op(독립추정)=0.000042s
...
## 집계 제외된 run (run_meta.json 없음/파싱 실패)
- 20260809_232438_b_fsm_cluster_repnolog1_nolog: run_meta.json 없음 -- 집계에서 제외
- 20260809_232850_b_fsm_strong_repspeedsanity1800x: run_meta.json 없음 -- 집계에서 제외
