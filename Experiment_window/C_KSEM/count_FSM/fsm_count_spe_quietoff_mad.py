"""
fsm_count_spe_quietoff_mad.py
============================
Count 단독 SPE onset 탐지 — 전 채널 일괄, 단일 방식 고정판 (quietoff + MAD (Ours)).
...
스키마. 파일명에 방식 태그가 붙어 4종이 섞이지 않는다.
  fsm_onset_quietoff_mad.csv / fsm_event_quietoff_mad.csv
...
TAG = "quietoff_mad"   # 출력 파일명 태그


# ══════════════════════════════════════════════════════════════════
# 배경 산포: MAD 기반 robust σ
# ══════════════════════════════════════════════════════════════════
def _sigma(x) -> float:
